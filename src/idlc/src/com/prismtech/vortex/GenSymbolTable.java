...
public class GenSymbolTable extends com.prismtech.vortex.parser.IDLBaseVisitor <Void>
{
  ...
  public Void visitWide_char_type (IDLParser.Wide_char_typeContext ctx)
  {
    ...
    {
      bogusType
        ("wide char data not supported in Vortex DDS", ctx.KW_WCHAR ());
    }
  ...
  public Void visitWide_string_type (IDLParser.Wide_string_typeContext ctx)
  {
    ...
    {
      bogusType
        ("wide string data not supported in Vortex DDS", ctx.KW_WSTRING ());
    }
  ...
  {
    bogusType
      ("fixed point data not supported in Vortex DDS", ctx.KW_FIXED ());
  ...
  public Void visitSequence_type (IDLParser.Sequence_typeContext ctx)
  {
    ...
    {
      bogusType
        ("bounded sequences not supported in Vortex DDS", ctx.KW_SEQUENCE ());
    }
  ...
  public Void visitFloating_pt_type (IDLParser.Floating_pt_typeContext ctx)
  {
    ...
    {
      bogusType
        ("long double data not supported in Vortex DDS", ctx.KW_LONG ());
    }
    if (currentTD != null)
    {
      currentTD.setNonintConst ();
