 ...
 *************************************************************************************************/
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance, invalid_params) = {
...
Theory((dds_entity_t *ent, void **buf, dds_sample_info_t *si, size_t bufsz, uint32_t maxs), vddsc_read_instance, invalid_params, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_wl, invalid_params) = {
        DataPoints(dds_entity_t*,               &g_reader, &g_rcond, &g_qcond),
        DataPoints(void**,                      g_loans, (void**)0),
        DataPoints(dds_sample_info_t*,          g_info, (dds_sample_info_t*)0),
        DataPoints(size_t,                      0, 2, MAX_SAMPLES),
};
Theory((dds_entity_t *ent, void **buf, dds_sample_info_t *si, uint32_t maxs), vddsc_read_instance_wl, invalid_params, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
    /* The only valid permutation is when non of the buffer values are
     * invalid and neither is the handle. So, don't test that. */
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask, invalid_params) = {
        DataPoints(dds_entity_t*,               &g_reader, &g_rcond, &g_qcond),
        DataPoints(void**,                      g_samples, g_loans, (void**)0),
        DataPoints(dds_sample_info_t*,          g_info, (dds_sample_info_t*)0),
        DataPoints(size_t,                      0, 2, MAX_SAMPLES),
...
Theory((dds_entity_t *ent, void **buf, dds_sample_info_t *si, size_t bufsz, uint32_t maxs), vddsc_read_instance_mask, invalid_params, .init=read_instance_init, .fini=read_instance_fini)
{
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask_wl, invalid_params) = {
        DataPoints(dds_entity_t*,               &g_reader, &g_rcond, &g_qcond),
        DataPoints(void**,                      g_loans, (void**)0),
        DataPoints(dds_sample_info_t*,          g_info, (dds_sample_info_t*)0),
        DataPoints(size_t,                      0, 2, MAX_SAMPLES),
};
Theory((dds_entity_t *ent, void **buf, dds_sample_info_t *si, uint32_t maxs), vddsc_read_instance_mask_wl, invalid_params, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t ret;
    /* The only valid permutation is when non of the buffer values are
 ...
 *************************************************************************************************/
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance, invalid_handles) = {
        DataPoints(dds_entity_t*,         &g_reader, &g_rcond, &g_qcond),
        DataPoints(dds_instance_handle_t, DDS_HANDLE_NIL, 0, 1, 100, UINT64_MAX),
};
Theory((dds_entity_t *rdr, dds_instance_handle_t hdl), vddsc_read_instance, invalid_handles, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_wl, invalid_handles) = {
        DataPoints(dds_entity_t*,         &g_reader, &g_rcond, &g_qcond),
        DataPoints(dds_instance_handle_t, DDS_HANDLE_NIL, 0, 1, 100, UINT64_MAX),
};
Theory((dds_entity_t *rdr, dds_instance_handle_t hdl), vddsc_read_instance_wl, invalid_handles, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask, invalid_handles) = {
        DataPoints(dds_entity_t*,         &g_reader, &g_rcond, &g_qcond),
        DataPoints(dds_instance_handle_t, DDS_HANDLE_NIL, 0, 1, 100, UINT64_MAX),
};
Theory((dds_entity_t *rdr, dds_instance_handle_t hdl), vddsc_read_instance_mask, invalid_handles, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask_wl, invalid_handles) = {
        DataPoints(dds_entity_t*,         &g_reader, &g_rcond, &g_qcond),
        DataPoints(dds_instance_handle_t, DDS_HANDLE_NIL, 0, 1, 100, UINT64_MAX),
};
Theory((dds_entity_t *rdr, dds_instance_handle_t hdl), vddsc_read_instance_mask_wl, invalid_handles, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t ret;
 ...
 *************************************************************************************************/
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance, invalid_readers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t rdr), vddsc_read_instance, invalid_readers, .init=read_instance_init, .fini=read_instance_fini)
{
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_wl, invalid_readers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t rdr), vddsc_read_instance_wl, invalid_readers, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask, invalid_readers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t rdr), vddsc_read_instance_mask, invalid_readers, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask_wl, invalid_readers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t rdr), vddsc_read_instance_mask_wl, invalid_readers, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
 ...
 *************************************************************************************************/
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance, non_readers) = {
        DataPoints(dds_entity_t*, &g_participant, &g_topic, &g_writer, &g_subscriber, &g_publisher, &g_waitset),
};
Theory((dds_entity_t *rdr), vddsc_read_instance, non_readers, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
    ret = dds_read_instance(*rdr, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES, g_hdl_valid);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_wl, non_readers) = {
        DataPoints(dds_entity_t*, &g_participant, &g_topic, &g_writer, &g_subscriber, &g_publisher, &g_waitset),
};
Theory((dds_entity_t *rdr), vddsc_read_instance_wl, non_readers, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
    ret = dds_read_instance_wl(*rdr, g_loans, g_info, MAX_SAMPLES, g_hdl_valid);
    cr_assert_eq(dds_err_nr(ret), DDS_RETCODE_ILLEGAL_OPERATION, "returned %d", dds_err_nr(ret));
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask, non_readers) = {
        DataPoints(dds_entity_t*, &g_participant, &g_topic, &g_writer, &g_subscriber, &g_publisher, &g_waitset),
};
Theory((dds_entity_t *rdr), vddsc_read_instance_mask, non_readers, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t ret;
    ret = dds_read_instance_mask(*rdr, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES, g_hdl_valid, mask);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask_wl, non_readers) = {
        DataPoints(dds_entity_t*, &g_participant, &g_topic, &g_writer, &g_subscriber, &g_publisher, &g_waitset),
};
Theory((dds_entity_t *rdr), vddsc_read_instance_mask_wl, non_readers, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t ret;
    ret = dds_read_instance_mask_wl(*rdr, g_loans, g_info, MAX_SAMPLES, g_hdl_valid, mask);
 ...
 *************************************************************************************************/
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance, already_deleted) = {
        DataPoints(dds_entity_t*, &g_rcond, &g_qcond, &g_reader),
};
Theory((dds_entity_t *rdr), vddsc_read_instance, already_deleted, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
    ret = dds_delete(*rdr);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_wl, already_deleted) = {
        DataPoints(dds_entity_t*, &g_rcond, &g_qcond, &g_reader),
};
Theory((dds_entity_t *rdr), vddsc_read_instance_wl, already_deleted, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t ret;
    ret = dds_delete(*rdr);
    cr_assert_eq(ret, DDS_RETCODE_OK, "prerequisite delete failed: %d", dds_err_nr(ret));
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask, already_deleted) = {
        DataPoints(dds_entity_t*, &g_rcond, &g_qcond, &g_reader),
};
Theory((dds_entity_t *rdr), vddsc_read_instance_mask, already_deleted, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t ret;
    ret = dds_delete(*rdr);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_read_instance_mask_wl, already_deleted) = {
        DataPoints(dds_entity_t*, &g_rcond, &g_qcond, &g_reader),
};
Theory((dds_entity_t *rdr), vddsc_read_instance_mask_wl, already_deleted, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t ret;
    ret = dds_delete(*rdr);
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_read_instance, reader, .init=read_instance_init, .fini=read_instance_fini)
{
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance::reader: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_wl, reader, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t expected_cnt = 2;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_wl::reader: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_mask, reader, .init=read_instance_init, .fini=read_instance_fini)
{
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_mask::reader: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_mask_wl, reader, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_NOT_READ_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t expected_cnt = 1;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_mask_wl::reader: Read", (*sample));
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_read_instance, readcondition, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t expected_cnt = 1;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance::readcondition: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_wl, readcondition, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t expected_cnt = 1;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_wl::readcondition: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_mask, readcondition, .init=read_instance_init, .fini=read_instance_fini)
{
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_mask::readcondition: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_mask_wl, readcondition, .init=read_instance_init, .fini=read_instance_fini)
{
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_mask_wl::readcondition: Read", (*sample));
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_read_instance, querycondition, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t expected_cnt = 1;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance::querycondition: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_wl, querycondition, .init=read_instance_init, .fini=read_instance_fini)
{
    dds_return_t expected_cnt = 1;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_wl::querycondition: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_mask, querycondition, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_READ_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t expected_cnt = 1;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_mask::querycondition: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_read_instance_mask_wl, querycondition, .init=read_instance_init, .fini=read_instance_fini)
{
    uint32_t mask = DDS_NOT_READ_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_return_t expected_cnt = 1;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         *    |    3   |    4   |    8   | not_read | new | no_writers |
         */
        PRINT_SAMPLE("vddsc_read_instance_mask_wl::querycondition: Read", (*sample));
