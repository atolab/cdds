...
querycondition_init(void)
{
    ...
    g_topic = dds_create_topic(g_participant, &Space_Type1_desc, create_topic_name("vddsc_querycondition_test", name, sizeof name), NULL, NULL);
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_querycondition_create, second, .init=querycondition_init, .fini=querycondition_fini)
{
...
/*************************************************************************************************/
Test(vddsc_querycondition_create, deleted_reader, .init=querycondition_init, .fini=querycondition_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_entity_t cond;
    dds_delete(g_reader);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_querycondition_create, invalid_readers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t rdr), vddsc_querycondition_create, invalid_readers, .init=querycondition_init, .fini=querycondition_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_querycondition_create, non_readers) = {
        DataPoints(dds_entity_t*, &g_topic, &g_participant),
};
Theory((dds_entity_t *rdr), vddsc_querycondition_create, non_readers, .init=querycondition_init, .fini=querycondition_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_entity_t cond;
    cond = dds_create_querycondition(*rdr, mask, filter_mod2);
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_querycondition_read, any, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_read::any: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, not_read_sample_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_read::not_read_sample_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, read_sample_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_read::read_sample_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, new_view_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_read::new_view_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, not_new_view_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_read::not_new_view_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, alive_instance_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_read::alive_instance_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, disposed_instance_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_read::disposed_instance_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, no_writers_instance_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_read::no_writers_instance_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, combination_of_states, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_read::combination_of_states: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, none, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, with_mask, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_read::with_mask: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_read, already_deleted, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_querycondition_take, any, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_take::any: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, not_read_sample_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_take::not_read_sample_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, read_sample_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_take::read_sample_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, new_view_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_take::new_view_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, not_new_view_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_take::not_new_view_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, alive_instance_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_take::alive_instance_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, disposed_instance_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_take::disposed_instance_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, no_writers_instance_state, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_querycondition_take::no_writers_instance_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, combination_of_states, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_take::combination_of_states: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, none, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, with_mask, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_querycondition_take::with_mask: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_querycondition_take, already_deleted, .init=querycondition_init, .fini=querycondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
