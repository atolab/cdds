 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_readcondition_create, second, .init=readcondition_init, .fini=readcondition_fini)
{
...
/*************************************************************************************************/
Test(vddsc_readcondition_create, deleted_reader, .init=readcondition_init, .fini=readcondition_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_entity_t cond;
    dds_delete(g_reader);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_readcondition_create, invalid_readers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t rdr), vddsc_readcondition_create, invalid_readers, .init=readcondition_init, .fini=readcondition_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_readcondition_create, non_readers) = {
        DataPoints(dds_entity_t*, &g_topic, &g_participant),
};
Theory((dds_entity_t *rdr), vddsc_readcondition_create, non_readers, .init=readcondition_init, .fini=readcondition_fini)
{
    uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
    dds_entity_t cond;
    cond = dds_create_readcondition(*rdr, mask);
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_readcondition_read, any, .init=readcondition_init, .fini=readcondition_fini)
{
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_read::any: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, not_read_sample_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_read::not_read_sample_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, read_sample_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_read::read_sample_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, new_view_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_read::new_view_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, not_new_view_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_read::not_new_view_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, alive_instance_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_read::alive_instance_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, disposed_instance_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_read::disposed_instance_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, no_writers_instance_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_read::no_writers_instance_state: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, combination_of_states, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_read::combination_of_states: Read", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, none, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_readcondition_read, with_mask, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_read::with_mask: Read", (*sample));
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_readcondition_take, any, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_take::any: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, not_read_sample_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_take::not_read_sample_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, read_sample_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_take::read_sample_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, new_view_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_take::new_view_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, not_new_view_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_take::not_new_view_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, alive_instance_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_take::alive_instance_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, disposed_instance_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_take::disposed_instance_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, no_writers_instance_state, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_take::no_writers_instance_state: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, combination_of_states, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      |
         */
        PRINT_SAMPLE("vddsc_readcondition_take::combination_of_states: Take", (*sample));
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, none, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_readcondition_take, with_mask, .init=readcondition_init, .fini=readcondition_fini)
{
    dds_entity_t condition;
    dds_return_t ret;
    ...
    for(int i = 0; i < ret; i++) {
         ...
         * |    6   |    3   |    2   | not_read | new | alive      | <---
         */
        PRINT_SAMPLE("vddsc_readcondition_take::with_mask: Take", (*sample));
