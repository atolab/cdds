...
disposing_init(void)
{
    ...
    snprintf(name, 100,
            "vddsc_disposing_test_pid%"PRIprocId"_tid%d",
            os_procIdSelf(),
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_writedispose, deleted, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    dds_delete(g_writer);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_writedispose, invalid_writers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t writer), vddsc_writedispose, invalid_writers, .init=disposing_init, .fini=disposing_fini)
{
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_writedispose, non_writers) = {
...
/*************************************************************************************************/
Test(vddsc_writedispose, disposing_old_instance, .init=disposing_init, .fini=disposing_fini)
{
...
/*************************************************************************************************/
Test(vddsc_writedispose, disposing_new_instance, .init=disposing_init, .fini=disposing_fini)
{
...
/*************************************************************************************************/
Test(vddsc_writedispose, timeout, .init=disposing_init, .fini=disposing_fini)
{
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_writedispose_ts, deleted, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    dds_delete(g_writer);
...
/*************************************************************************************************/
Test(vddsc_writedispose_ts, timeout, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 newInstance1 = { INITIAL_SAMPLES  , 22, 22 };
    Space_Type1 newInstance2 = { INITIAL_SAMPLES+1, 42, 42 };
    dds_attach_t triggered;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_writedispose_ts, invalid_writers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t writer), vddsc_writedispose_ts, invalid_writers, .init=disposing_init, .fini=disposing_fini)
{
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
    uint32_t mask;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_writedispose_ts, non_writers) = {
        DataPoints(dds_entity_t*, &g_waitset, &g_reader, &g_topic, &g_participant),
};
...
/*************************************************************************************************/
Test(vddsc_writedispose_ts, disposing_old_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 oldInstance = { 0, 22, 22 };
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_writedispose_ts, disposing_new_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 newInstance = { INITIAL_SAMPLES, 42, 42 };
    dds_return_t ret;
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_dispose, deleted, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    dds_delete(g_writer);
...
/*************************************************************************************************/
Test(vddsc_dispose, timeout, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 newInstance1 = { INITIAL_SAMPLES  , 22, 22 };
    Space_Type1 newInstance2 = { INITIAL_SAMPLES+1, 42, 42 };
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose, invalid_writers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t writer), vddsc_dispose, invalid_writers, .init=disposing_init, .fini=disposing_fini)
{
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
    uint32_t mask;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose, non_writers) = {
        DataPoints(dds_entity_t*, &g_waitset, &g_reader, &g_topic, &g_participant),
};
...
/*************************************************************************************************/
Test(vddsc_dispose, disposing_old_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 oldInstance = { 0, 22, 22 };
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_dispose, disposing_new_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 newInstance = { INITIAL_SAMPLES, 42, 42 };
    dds_return_t ret;
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_dispose_ts, deleted, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    dds_delete(g_writer);
...
/*************************************************************************************************/
Test(vddsc_dispose_ts, timeout, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 newInstance1 = { INITIAL_SAMPLES  , 22, 22 };
    Space_Type1 newInstance2 = { INITIAL_SAMPLES+1, 42, 42 };
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ts, invalid_writers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t writer), vddsc_dispose_ts, invalid_writers, .init=disposing_init, .fini=disposing_fini)
{
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
    uint32_t mask;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ts, non_writers) = {
        DataPoints(dds_entity_t*, &g_waitset, &g_reader, &g_topic, &g_participant),
};
...
/*************************************************************************************************/
Test(vddsc_dispose_ts, disposing_old_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 oldInstance = { 0, 22, 22 };
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_dispose_ts, disposing_new_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 newInstance = { INITIAL_SAMPLES, 42, 42 };
    dds_return_t ret;
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_dispose_ih, deleted, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    dds_delete(g_writer);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ih, invalid_handles) = {
        DataPoints(dds_instance_handle_t, DDS_HANDLE_NIL, 0, 1, 100, UINT64_MAX),
};
Theory((dds_instance_handle_t handle), vddsc_dispose_ih, invalid_handles, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ih, invalid_writers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t writer), vddsc_dispose_ih, invalid_writers, .init=disposing_init, .fini=disposing_fini)
{
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
    uint32_t mask;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ih, non_writers) = {
        DataPoints(dds_entity_t*, &g_waitset, &g_reader, &g_topic, &g_participant),
};
Theory((dds_entity_t *writer), vddsc_dispose_ih, non_writers, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    ret = dds_dispose_ih(*writer, DDS_HANDLE_NIL);
    cr_assert_eq(dds_err_nr(ret), DDS_RETCODE_ILLEGAL_OPERATION, "returned %d", dds_err_nr(ret));
...
/*************************************************************************************************/
Test(vddsc_dispose_ih, disposing_old_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 oldInstance = { 0, 22, 22 };
 ...
 *************************************************************************************************/
/*************************************************************************************************/
Test(vddsc_dispose_ih_ts, deleted, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    dds_delete(g_writer);
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ih_ts, invalid_handles) = {
        DataPoints(dds_instance_handle_t, DDS_HANDLE_NIL, 0, 1, 100, UINT64_MAX),
};
Theory((dds_instance_handle_t handle), vddsc_dispose_ih_ts, invalid_handles, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ih_ts, invalid_writers) = {
        DataPoints(dds_entity_t, -2, -1, 0, 1, 100, INT_MAX, INT_MIN),
};
Theory((dds_entity_t writer), vddsc_dispose_ih_ts, invalid_writers, .init=disposing_init, .fini=disposing_fini)
{
    dds_entity_t exp = DDS_RETCODE_BAD_PARAMETER * -1;
    dds_return_t ret;
    uint32_t mask;
...
/*************************************************************************************************/
TheoryDataPoints(vddsc_dispose_ih_ts, non_writers) = {
        DataPoints(dds_entity_t*, &g_waitset, &g_reader, &g_topic, &g_participant),
};
Theory((dds_entity_t *writer), vddsc_dispose_ih_ts, non_writers, .init=disposing_init, .fini=disposing_fini)
{
    dds_return_t ret;
    ret = dds_dispose_ih_ts(*writer, DDS_HANDLE_NIL, g_present);
    cr_assert_eq(dds_err_nr(ret), DDS_RETCODE_ILLEGAL_OPERATION, "returned %d", dds_err_nr(ret));
...
/*************************************************************************************************/
Test(vddsc_dispose_ih_ts, disposing_old_instance, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 oldInstance = { 0, 22, 22 };
    dds_instance_handle_t hdl = dds_instance_lookup(g_writer, &oldInstance);
    dds_return_t ret;
...
/*************************************************************************************************/
Test(vddsc_dispose_ih_ts, disposing_past_sample, .init=disposing_init, .fini=disposing_fini)
{
    Space_Type1 oldInstance = { 0, 0, 0 };
    dds_instance_handle_t hdl = dds_instance_lookup(g_writer, &oldInstance);
    dds_attach_t triggered;
