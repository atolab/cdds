...
/* stubs */
#define dds_alloc malloc
#define dds_free free
/* end stubs */
...
void
dds_listener_delete(_Inout_ dds_listener_t * restrict listener)
{
    assert(listener);
...
{
    c99_listener_t *srcl, *dstl;

    assert(dst);
    assert(src);

    srcl = (c99_listener_t*)src;
    dstl = (c99_listener_t*)dst;
...
void
dds_lget_data_available (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_data_available_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_data_on_readers (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_data_on_readers_fn *callback)
{
    assert(listener);
    assert(callback);
...
void dds_lget_inconsistent_topic (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_inconsistent_topic_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_liveliness_changed (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_liveliness_changed_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_liveliness_lost (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_liveliness_lost_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_offered_deadline_missed (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_offered_deadline_missed_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_offered_incompatible_qos (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_offered_incompatible_qos_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_publication_matched (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_publication_matched_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_requested_deadline_missed (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_requested_deadline_missed_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_requested_incompatible_qos (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_requested_incompatible_qos_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_sample_lost (_In_ dds_listener_t *restrict listener, _Outptr_result_maybenull_ dds_on_sample_lost_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_sample_rejected (_In_ dds_listener_t  *restrict listener, _Outptr_result_maybenull_ dds_on_sample_rejected_fn *callback)
{
    assert(listener);
    assert(callback);
...
void
dds_lget_subscription_matched (_In_ dds_listener_t * restrict listener, _Outptr_result_maybenull_ dds_on_subscription_matched_fn *callback)
{
    assert(listener);
    assert(callback);
