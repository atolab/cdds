...
elseif(CMAKE_SYSTEM_NAME MATCHES "Linux")
  ...
  if(EXISTS "/etc/redhat-release")
    ...
    # It is a bit of a hit-and-miss which of CPACK_PACKAGE_FILE_NAME or CPACK_RPM_<COMPONENT>_FILE_NAME is picked up, so set both.
    set(CPACK_PACKAGE_FILE_NAME "${CPACK_RPM_LIB_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}-${__arch}")
    set(CPACK_RPM_LIB_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}.rpm")
  ...
  elseif(EXISTS "/etc/debian_version")
    ...
    # It is a bit of a hit-and-miss which of CPACK_PACKAGE_FILE_NAME or CPACK_DEBIAN_<COMPONENT>_FILE_NAME is picked up, so set both.
    set(CPACK_PACKAGE_FILE_NAME "${CPACK_DEBIAN_LIB_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}_${__arch}")
    set(CPACK_DEBIAN_LIB_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}.deb")
