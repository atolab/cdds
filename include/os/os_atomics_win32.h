...
OS_ATOMIC_API_INLINE os_uint32 os_atomic_ld32 (const volatile os_atomic_uint32_t *x) { return x->v; }
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_ld64 (const volatile os_atomic_uint64_t *x) { return x->v; }
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_ldptr (const volatile os_atomic_uintptr_t *x) { return x->v; }
OS_ATOMIC_API_INLINE void *os_atomic_ldvoidp (const volatile os_atomic_voidp_t *x) { return (void *) os_atomic_ldptr (x); }

OS_ATOMIC_API_INLINE void os_atomic_st32 (volatile os_atomic_uint32_t *x, os_uint32 v) { x->v = v; }
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE void os_atomic_st64 (volatile os_atomic_uint64_t *x, os_uint64 v) { x->v = v; }
#endif
OS_ATOMIC_API_INLINE void os_atomic_stptr (volatile os_atomic_uintptr_t *x, os_address v) { x->v = v; }
OS_ATOMIC_API_INLINE void os_atomic_stvoidp (volatile os_atomic_voidp_t *x, void *v) { os_atomic_stptr (x, (os_address) v); }

/* CAS */

OS_ATOMIC_API_INLINE int os_atomic_cas32 (volatile os_atomic_uint32_t *x, os_uint32 exp, os_uint32 des) {
  return InterlockedCompareExchange (&x->v, des, exp) == exp;
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE int os_atomic_cas64 (volatile os_atomic_uint64_t *x, os_uint64 exp, os_uint64 des) {
  return InterlockedCompareExchange64 (&x->v, des, exp) == exp;
}
#endif
OS_ATOMIC_API_INLINE int os_atomic_casptr (volatile os_atomic_uintptr_t *x, os_address exp, os_address des) {
...
OS_ATOMIC_API_INLINE int os_atomic_casvoidp (volatile os_atomic_voidp_t *x, void *exp, void *des) {
  return os_atomic_casptr ((volatile os_atomic_uintptr_t *) x, (os_address) exp, (os_address) des);
}
...
OS_ATOMIC_API_INLINE os_uint32 os_atomic_inc32_nv (volatile os_atomic_uint32_t *x) {
  return InterlockedIncrement (&x->v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_inc64_nv (volatile os_atomic_uint64_t *x) {
  return InterlockedIncrement64 (&x->v);
}
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_incptr_nv (volatile os_atomic_uintptr_t *x) {
...
OS_ATOMIC_API_INLINE os_uint32 os_atomic_dec32_nv (volatile os_atomic_uint32_t *x) {
  return InterlockedDecrement (&x->v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_dec64_nv (volatile os_atomic_uint64_t *x) {
...
OS_ATOMIC_API_INLINE void os_atomic_add32 (volatile os_atomic_uint32_t *x, os_uint32 v) {
  InterlockedExchangeAdd (&x->v, v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE void os_atomic_add64 (volatile os_atomic_uint64_t *x, os_uint64 v) {
  InterlockedExchangeAdd64 (&x->v, v);
}
#endif
OS_ATOMIC_API_INLINE void os_atomic_addptr (volatile os_atomic_uintptr_t *x, os_address v) {
...
OS_ATOMIC_API_INLINE void os_atomic_addvoidp (volatile os_atomic_voidp_t *x, ptrdiff_t v) {
  os_atomic_addptr ((volatile os_atomic_uintptr_t *) x, (os_address) v);
}
OS_ATOMIC_API_INLINE os_uint32 os_atomic_add32_nv (volatile os_atomic_uint32_t *x, os_uint32 v) {
  return InterlockedExchangeAdd (&x->v, v) + v;
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_add64_nv (volatile os_atomic_uint64_t *x, os_uint64 v) {
  return InterlockedExchangeAdd64 (&x->v, v) + v;
}
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_addptr_nv (volatile os_atomic_uintptr_t *x, os_address v) {
...
OS_ATOMIC_API_INLINE void *os_atomic_addvoidp_nv (volatile os_atomic_voidp_t *x, ptrdiff_t v) {
  return (void *) os_atomic_addptr_nv ((volatile os_atomic_uintptr_t *) x, (os_address) v);
}

/* SUB */

OS_ATOMIC_API_INLINE void os_atomic_sub32 (volatile os_atomic_uint32_t *x, os_uint32 v) {
  InterlockedExchangeAdd (&x->v, -v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE void os_atomic_sub64 (volatile os_atomic_uint64_t *x, os_uint64 v) {
  InterlockedExchangeAdd64 (&x->v, -v);
}
#endif
OS_ATOMIC_API_INLINE void os_atomic_subptr (volatile os_atomic_uintptr_t *x, os_address v) {
  OS_ATOMIC_PTROP (InterlockedExchangeAdd) (&x->v, -v);
}
OS_ATOMIC_API_INLINE void os_atomic_subvoidp (volatile os_atomic_voidp_t *x, ptrdiff_t v) {
  os_atomic_subptr ((volatile os_atomic_uintptr_t *) x, (os_address) v);
}
OS_ATOMIC_API_INLINE os_uint32 os_atomic_sub32_nv (volatile os_atomic_uint32_t *x, os_uint32 v) {
  return InterlockedExchangeAdd (&x->v, -v) - v;
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_sub64_nv (volatile os_atomic_uint64_t *x, os_uint64 v) {
  return InterlockedExchangeAdd64 (&x->v, -v) - v;
}
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_subptr_nv (volatile os_atomic_uintptr_t *x, os_address v) {
  return OS_ATOMIC_PTROP (InterlockedExchangeAdd) (&x->v, -v) - v;
}
OS_ATOMIC_API_INLINE void *os_atomic_subvoidp_nv (volatile os_atomic_voidp_t *x, ptrdiff_t v) {
  return (void *) os_atomic_subptr_nv ((volatile os_atomic_uintptr_t *) x, (os_address) v);
}
...
OS_ATOMIC_API_INLINE void os_atomic_and32 (volatile os_atomic_uint32_t *x, os_uint32 v) {
  OS_ATOMIC_INTERLOCKED_AND (&x->v, v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE void os_atomic_and64 (volatile os_atomic_uint64_t *x, os_uint64 v) {
  InterlockedAnd64 (&x->v, v);
}
#endif
OS_ATOMIC_API_INLINE void os_atomic_andptr (volatile os_atomic_uintptr_t *x, os_address v) {
  OS_ATOMIC_PTROP (OS_ATOMIC_INTERLOCKED_AND) (&x->v, v);
}
OS_ATOMIC_API_INLINE os_uint32 os_atomic_and32_ov (volatile os_atomic_uint32_t *x, os_uint32 v) {
  return OS_ATOMIC_INTERLOCKED_AND (&x->v, v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_and64_ov (volatile os_atomic_uint64_t *x, os_uint64 v) {
  return InterlockedAnd64 (&x->v, v);
}
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_andptr_ov (volatile os_atomic_uintptr_t *x, os_address v) {
  return OS_ATOMIC_PTROP (OS_ATOMIC_INTERLOCKED_AND) (&x->v, v);
}
OS_ATOMIC_API_INLINE os_uint32 os_atomic_and32_nv (volatile os_atomic_uint32_t *x, os_uint32 v) {
  return OS_ATOMIC_INTERLOCKED_AND (&x->v, v) & v;
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_and64_nv (volatile os_atomic_uint64_t *x, os_uint64 v) {
  return InterlockedAnd64 (&x->v, v) & v;
}
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_andptr_nv (volatile os_atomic_uintptr_t *x, os_address v) {
...
OS_ATOMIC_API_INLINE void os_atomic_or32 (volatile os_atomic_uint32_t *x, os_uint32 v) {
  OS_ATOMIC_INTERLOCKED_OR (&x->v, v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE void os_atomic_or64 (volatile os_atomic_uint64_t *x, os_uint64 v) {
  InterlockedOr64 (&x->v, v);
}
#endif
OS_ATOMIC_API_INLINE void os_atomic_orptr (volatile os_atomic_uintptr_t *x, os_address v) {
  OS_ATOMIC_PTROP (OS_ATOMIC_INTERLOCKED_OR) (&x->v, v);
}
OS_ATOMIC_API_INLINE os_uint32 os_atomic_or32_ov (volatile os_atomic_uint32_t *x, os_uint32 v) {
  return OS_ATOMIC_INTERLOCKED_OR (&x->v, v);
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_or64_ov (volatile os_atomic_uint64_t *x, os_uint64 v) {
  return InterlockedOr64 (&x->v, v);
}
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_orptr_ov (volatile os_atomic_uintptr_t *x, os_address v) {
  return OS_ATOMIC_PTROP (OS_ATOMIC_INTERLOCKED_OR) (&x->v, v);
}
OS_ATOMIC_API_INLINE os_uint32 os_atomic_or32_nv (volatile os_atomic_uint32_t *x, os_uint32 v) {
  return OS_ATOMIC_INTERLOCKED_OR (&x->v, v) | v;
}
#if OS_ATOMIC64_SUPPORT
OS_ATOMIC_API_INLINE os_uint64 os_atomic_or64_nv (volatile os_atomic_uint64_t *x, os_uint64 v) {
  return InterlockedOr64 (&x->v, v) | v;
}
#endif
OS_ATOMIC_API_INLINE os_address os_atomic_orptr_nv (volatile os_atomic_uintptr_t *x, os_address v) {
