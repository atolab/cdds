...
#define OS_LIB_LOAD_PATH_VAR OS_OS_LIB_LOAD_PATH_VAR
	...
	/**
	 * \brief the os_set_opterr function sets the value of opterr variable.
	 ...
	 * Possible results:
	 * - No error information is returned.
	 * Set the value of opterr variable.
	 *
	 */
	OSAPI_EXPORT void
	...
	/**
	 * \brief the os_get_opterr returns the value of opterr variable.
	 * opterr is used as a flag to suppress an error message generated by
	 * getopt. When opterr is set to 0, it suppresses the error message generated
	 * by getopt when that function does not recognize an option character.
	 *
	 ...
	 *
	 * Possible results:
	 * - return the value of opterr variable.
	 *
	 */
	OSAPI_EXPORT int
	os_get_opterr(void);
	 ...
	 * Possible results:
	 * - No error information is returned.
	 * Set the value of optind variable.
	 *
	 */
	OSAPI_EXPORT void
	 ...
	 *
	 * Possible results:
	 * - return the value of optind variable.
	 *
	 */
	OSAPI_EXPORT int
	os_get_optind(void);
	 ...
	 *
	 * Possible results:
	 * - return the value of optopt variable.
	 *
	 */
	OSAPI_EXPORT int
	os_get_optopt(void);
	 ...
	 *
	 * Possible results:
	 * - return the value of optarg variable.
	 *
	 */
	OSAPI_EXPORT char *
	os_get_optarg(void);
